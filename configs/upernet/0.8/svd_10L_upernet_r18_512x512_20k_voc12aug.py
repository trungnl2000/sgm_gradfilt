...
svd_var = dict(
    ...
    filter_install=[
        ...
        dict(path="decode_head.lateral_convs.0", type='cbr', SVD_var=0.8),
        dict(path="decode_head.lateral_convs.1", type='cbr', SVD_var=0.8),
        dict(path="decode_head.lateral_convs.2", type='cbr', SVD_var=0.8),
